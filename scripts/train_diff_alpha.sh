...
for (( i=1; i<num_args; i++ )); do
    ...
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_geoinitbia0d1_stc_sched_0d007_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.007 \
    ...
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_geoinitbia0d1_stc_sched_0d015_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.015 \
    # --save_results_per_step 1000 \
    ...
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_geoinitbia0d1_stc_sched_0d03125_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.03125 \
    # --save_results_per_step 1000 \
    ...
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_geoinitbia0d1_stc_sched_0d0625_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.0625 \
    # --save_results_per_step 1000 \
    ...
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_geoinitbia0d1_stc_sched_0d125_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.125 \
    # --save_results_per_step 1000 \
