...
for (( i=1; i<num_args; i++ )); do
    ...
    ## train 0. fourier feat with geometric init bias=0.1
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_geoinitbia0d1" \
    --stc_start 2000 \
    --stc_end 2000 \
    ...
    ## train 1. stochastic fourier feat with geometric init bias=0.1
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type stc_ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_geoinitbia0d1_stc_sched_0d0625_2k2k" \
    --stc_start 2000 \
    --stc_end 2000 \
    --stc_init 0.0625 \
    --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
    ...
    ## train 0. fourier feat with geometric init bias=0.8
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_geoinitbia0d8" \
    --stc_start 2000 \
    --stc_end 2000 \
    --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
    --online y \
    ...
    ## train 1. stochastic fourier feat with geometric init bias=0.8
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type stc_ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_geoinitbia0d8_stc_sched_0d0625_2k2k" \
    --stc_start 2000 \
    --stc_end 2000 \
    --stc_init 0.0625 \
    --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
    ...
    ## train 2. fourier feat without geometric init 
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_nogeoinit" \
    --stc_start 2000 \
    --stc_end 2000 \
    --stc_init 0.0625 \
    --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
    ...
    ## train 3. stochastic fourier feat without geometric init
    echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    --wandb_proj "Point-Normal SDF Fitting Final" \
    --model_type stc_ingp \
    --point_cloud_path=$item \
    --batch_size=250000 \
    --experiment_name=$meshname"_fourier_nogeoinit_stc_sched_0d0625_2k2k" \
    --stc_start 2000 \
    --stc_end 2000 \
    --stc_init 0.0625 \
    --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
