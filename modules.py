...
## Borrowed from https://github.com/liuzhen0212/FINER
...
class Finer(nn.Module):
    def __init__(self, in_features, hidden_features, hidden_layers, out_features, first_omega_0=30, hidden_omega_0=30.0, bias=True, 
                 first_bias_scale=None, scale_req_grad=False, stochastic=False):
        super().__init__()
        self.net = []
    ...
    def forward(self, coords):
        ...
        if self.stochasticP:
            ...
            coords = coords_normalized * 2.0 - 1.0

        output = self.net(coords)
        
        return {'model_in': coords,
                'model_out': output}
