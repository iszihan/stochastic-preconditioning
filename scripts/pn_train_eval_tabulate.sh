...
for (( i=1; i<num_args; i++ )); do
    ...
    # gpui=$(( (gpui + 1) % $ngpu )) # increment gpu 
    # ## train 4. ingp without geometric init 
    # echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    # --wandb_proj "Point-Normal SDF Fitting Final" \
    # --model_type ingp \
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_nogeoinit" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.0625 \
    ...
    # gpui=$(( (gpui + 1) % $ngpu )) # increment gpu 
    # ## train 5. stochastic ingp without geometric init 
    # echo CUDA_VISIBLE_DEVICES=$gpui python experiment_scripts/train_sdf.py \
    # --wandb_proj "Point-Normal SDF Fitting Final" \
    # --model_type stc_ingp \
    # --point_cloud_path=$item \
    # --batch_size=250000 \
    # --experiment_name=$meshname"_ingp_nogeoinit_stc_sched_0d0625_2k2k" \
    # --stc_start 2000 \
    # --stc_end 2000 \
    # --stc_init 0.0625 \
    # --steps_for_ckpt 2500-3000-5000-8000-10000-20000-50000-100000 \
