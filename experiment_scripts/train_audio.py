...
elif opt.model_type == 'hashgrid':
    model = modules.INGP(stochastic=False)
elif opt.model_type == 'stc_hashgrid':
    model = modules.INGP(stochastic=True)
elif opt.model_type == 'nffb':
    model = modules.NFFB(stochastic=False)
elif opt.model_type == 'stc_nffb':
    model = modules.NFFB(stochastic=True)
else:
